...
import STURDeCAM39 from "../../../../assets/allcameras/sturdecam39.png"
...
const cameraData = {
    ...
    'STURDeCAM34': {
        ...
        image: STURDeCAM34, // Added image directly to data
    },
    'STURDeCAM88': {
        tableData: [
    ...
    'STURDeCAM84': {
        ...
        siteUrl: "https://www.e-consystems.com/automotive-cameras/4k-ar0823at-ip69k-gmsl2-150db-hdr-camera.asp",
        buynow: null, // No buynow link in original data for this
        image: STURDeCAM84, // Added image directly to data
    },
    'RouteCAM_CU22': {
        tableData: [
        ...
        buynow: null, // No buynow link in original data for this
        image: routecam22, // Added image directly to data
    },
    'STURDeCAM12': {
        tableData: [
    ...
    'STURDeCAM39': {
        tableData: [
            ['Sensor', 'OMNIVISION OX03J10'],
            ['Frame Rate', '3 MP @ 30 fps'],
            ['Output Format', 'UYVY'],
            ['Interface', 'GMSL2&trade;'],
            ['FOV', 'TBD'],
            ['Temperature', '-40°C to 85°C'],
        ...
        highlights: [
            'Houses OMNIVISION OX03J10 Image Sensor with on-chip ISP',
            "140dB HDR + LFM",
            "GMSL2 interface to transmit power and data up to 15m",
            "Automotive grade IP69K rated enclosure",
        ],
        title: "STURDeCAM39 - 3MP 140dB HDR Surround View GMSL2 Camera",
        image: STURDeCAM39, // Added image directly to data
        siteUrl: "https://www.e-consystems.com/gmsl-cameras/3mp-ox03j10-140db-hdr-surround-view-gmsl2-camera.asp",
    },
};
...
const tabStructure = {
    ...
    '3MP GMSL2': {
        tabs: ['STURDeCAM39','STURDeCAM31', 'STURDeCAM34'],
        bgColor: 'white',
        color: '#344ea1',
    },
    '4K GMSL2': {
