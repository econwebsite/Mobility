...
const HomeCardCarousel = () => {
  ...
  const cards = [
    ...
    { image: vegitable, link: "/RetailExperience", title: "How vision-based shelf monitoring helps retailers", text: "The shelves in retail stores are packed with thousands of unique Consumer Packaged Goods (CPG). Retail store own..." },
