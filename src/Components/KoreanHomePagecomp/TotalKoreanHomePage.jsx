...
const TotalKoreanHomePage = () => {
  ...
  return (
    <div style={{ padding: '0px', margin: '0px' }}>
      {isContactPage && (
        <Helmet>
          <title>Rugged IP69K ADAS Cameras for Autonomous and Off-Road Mobility</title>
          <meta
            name="description"
            content="IP69K ADAS cameras with HDR, LFM and ISO/IATF-certified build. Engineered for autonomous, off-road vehicles and delivery robots in extreme environments."
          />
        </Helmet>
      )}
      <Section index={0}>
...
export default TotalKoreanHomePage;
