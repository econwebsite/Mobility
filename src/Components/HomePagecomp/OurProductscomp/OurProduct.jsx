...
const OurProduct = () => {
  const cardsData = [
    ...
    { id: 3,img:rearview, title: "Rear View Cameras", text: "Our Rear View Camera captures crisp clear images and videos essential for long-distance monitoring and precise traffic signs and signals recognition. Equipped with High Dynamic Range (HDR) technology, they deliver clear images even in varying light conditions.",link:"" },
  ...
  return (
    <div className="OurProduct-wrapper">
      <h2 className="OurProduct-heading">Our Products</h2>
